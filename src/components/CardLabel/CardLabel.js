...
import removeButtonBlack from '../../images/remove-black.svg';
import removeButtonGrey from '../../images/remove-grey.svg';
...
const CardLabel = ({ text = 'Placeholder', isSaved }) => {
    ...
    const [trashIcon, setTrashIcon] = useState(removeButtonGrey);
                ...
                <>
                    <div className="label-contianer label-container_right">
                        ...
                        <button
                            ...
                            onMouseEnter={() => setTrashIcon(removeButtonBlack)}
                            onMouseLeave={() => setTrashIcon(removeButtonGrey)}
                            className="label-button"
                            type="button"
                        >
